#!/usr/bin/env python3
"""Add §5.1 element-wise ops to 3.0A and refresh Math by Hand prereq cross-references in deep notebooks.

Idempotent: checks for section marker before inserting into 3.0A; deep notebooks get a fresh
prereq paragraph every run (so editing PREREQS below and re-running is safe).
"""
...
MATH_BY_HAND = {
    "3_2_1_dssm": (
        "**先修（在 3.0A 学过）：** §2 余弦相似度、§4 Sigmoid、§5 Softmax 与温度。"
    ...
    "3_3_3_dien": (
        "**先修：** §4 Sigmoid/Tanh、§5 加权汇总、§5.1 逐元素乘积。"
